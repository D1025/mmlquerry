...
const EXAMPLE_CATEGORY_FLOW: ExampleCategoryDefinition[] = [
  {
    id: 'foundations',
    title: 'Podstawy i filtrowanie nodów',
    description:
      'Od prostych zapytań where proposition has ... do filtrowania po spelling i patternach.',
  },
  {
    id: 'negation',
    title: 'Negacja i logika',
    description:
      'Operatory not/and/or/butnot oraz negacja warunków has/spelling/redefine.',
  },
  {
    id: 'nodes-redefine',
    title: 'Nodes, redefine i atrybuty',
    description:
      'Praca na pipeline nodes, skrótach redefine oraz predykatach opartych o atrybuty XML.',
  },
  {
    id: 'path-depth',
    title: 'Ścieżki i głębokość',
    description:
      'Nowa mechanika relacji A/B, A//B i A/N/B dla potomków o różnej głębokości.',
  },
  {
    id: 'symbols',
    title: 'Symbole i wystąpienia',
    description:
      'Lista symboli, grupowanie occurrences oraz wyszukiwanie z wildcard i escapowaniem.',
  },
  {
    id: 'cardinality-numeric',
    title: 'Liczność i porównania liczbowe',
    description:
      'Operatory where* i num* do analizy liczby wystąpień i wartości liczbowych.',
  },
  {
    id: 'composed',
    title: 'Złożone scenariusze',
    description:
      'Łączenie wielu warunków i operatorów w praktycznych zapytaniach analitycznych.',
  },
]
...
export const EXAMPLE_QUERY_LIBRARY: ExampleQueryDefinition[] = [
  ...
  },
  {
    ...
    title: 'InfixTerm po spelling (skrót)',
    description:
      "Skrót zapisu: proposition has InfixTerm spelling 'Element' zamiast [spelling='Element'].",
    query: "list of theorem where proposition has InfixTerm spelling 'Element'",
  },
  {
  ...
  },
  {
    ...
    description:
      "Dla tego artykułu '+' jest kodowane jako NAT_1:1, a '=' jako XBOOLE_0:4. Zapytanie szuka obu w tej samej propozycji.",
    query:
  ...
  },
  {
    ...
    title: 'Stwierdzenia z + oraz < (ABCMIZ_0)',
    description:
      "Wariant z porównaniem: '+' (NAT_1:1) i '<' (ORDERS_2:3) w tej samej propozycji.",
    query:
  ...
  },
  {
    ...
    title: 'Pipeline nodes + spelling (skrót)',
    description:
      "Skrót zapisu spelling: has * spelling 'Noetherian' oraz wariant globalny: spelling 'Noetherian'.",
    query: "list of definition | nodes Item where has * spelling 'Noetherian'",
  },
  {
    id: 'nodes-path-direct-child',
    title: 'Ścieżka nodów A/B',
    description:
      'A/B oznacza relację dziecko. Ten przykład ma trafienia i pozwala szybko sprawdzić mechanikę.',
  ...
  },
  {
    ...
    title: 'Ścieżka nodów A//B',
    description:
      'A//B oznacza dowolną głębokość potomka. W praktyce powinno zwrócić wyniki dla tego samego obszaru.',
    query: 'list of definition in ABCMIZ_0 | nodes Item where has Loci-Declaration//Variable',
  },
  {
    id: 'nodes-path-exact-depth',
    title: 'Ścieżka nodów A/4/B',
    description:
      'A/N/B oznacza dokładną głębokość. Tutaj Variable jest dokładnie 4 poziomy pod Loci-Declaration.',
    query: 'list of definition in ABCMIZ_0 | nodes Item where has Loci-Declaration/4/Variable',
  },
  {
    id: 'nodes-path-exact-depth-miss',
    title: 'Ścieżka nodów A/3/B (kontrola)',
    description:
      'Wariant kontrolny: zła głębokość powinna zwrócić 0 wyników, co potwierdza działanie filtra dokładnej głębi.',
    query: 'list of definition in ABCMIZ_0 | nodes Item where has Loci-Declaration/3/Variable',
  },
  {
    id: 'scoped-path-any-depth',
    title: 'Proposition + ścieżka A//B',
    description: 'Nowa składnia działa też w where proposition has ...',
  ...
  },
  {
    ...
    title: 'Proposition + ścieżka A/4/B',
    description: 'Wariant z dokładną głębią w scoped where.',
  ...
  },
  {
    ...
    description:
      "Negacja spelling przypięta do predykatu has: has * not spelling 'Noetherian'.",
  ...
  },
  {
    ...
    description:
      "Negacja spelling w where: odfiltrowuje nody, dla których istnieje spelling 'Noetherian'.",
  ...
  },
  {
    ...
    description:
      "Negacja typu noda: not has / has not, np. brak Redefine[occurs='true'] wśród potomków.",
    query: "list of definition | nodes Item where not has Redefine[occurs='true']",
  },
  {
    id: 'nodes-not-redefine-shorthand',
    title: 'Pipeline nodes + redefine (skrót negacji)',
    description:
      "Negacja logiczna: not redefine true (równoważne not has Redefine[occurs='true']); obejmuje też przypadki bez noda Redefine.",
    query: 'list of definition | nodes Item where not redefine true',
  },
  {
    id: 'nodes-redefine-false-shorthand',
    title: 'Pipeline nodes + redefine false (ściśle)',
    description:
      "Wariant ścisły: wymaga obecności Redefine z occurs='false' (bez przypadków, gdzie Redefine nie istnieje).",
  ...
  },
  {
    ...
    title: 'Literalne * i _',
    description: 'Wildcard to * oraz _. Aby szukać dosłownie tych znaków, użyj escape: \\* oraz \\_.',
  ...
  },
  {
    ...
    title: 'Liczby równe 1 (number =)',
    description: 'Skrócony zapis porównania liczbowego: number = N (równoważne numeq(N)).',
    query: 'list of statement | number = 1',
  },
  {
    id: 'node-cardinality-3-numerals',
    title: 'Co najmniej 3 liczby',
    description: 'Nowy operator liczebności nodów: minimum 3 nody NumeralTerm w item.',
  ...
  },
  {
    ...
    description:
      "Przykład praktyczny dla ABCMIZ_0: najpierw filtr po strukturze (+ i =), potem opcjonalnie filtr liczbowy.",
    query:
  ...
  },
  {
    ...
    title: 'Ogólnie: 3 liczby i symbole',
    description:
      'Wariant ogólny: co najmniej 3 liczby w jednej propozycji, dowolne symbole oraz wartość numeryczna > 200.',
    query:
  ...
  },
  {
    ...
    description:
      'Precyzyjny wariant: min. 3 NumeralTerm i min. 2 InfixTerm w jednej Proposition oraz wartość numeryczna > 200.',
    query:
  ...
  if (uncategorized.length > 0) {
    sections.push({
      category: {
        id: 'other',
        title: 'Pozostałe',
        description: 'Przykłady, które nie zostały przypisane do głównej ścieżki.',
      },
